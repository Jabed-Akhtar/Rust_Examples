/* Code credit: YouTube > Green Tea Coding > Rust TUI Tutorial: Ratatui, Multithreading, and Responsiveness
 */

use std::{io, sync::mpsc, thread, time::Duration};
use ratatui::{
    crossterm::event::{KeyEvent, KeyEventKind, KeyCode}, // For handling keyboard input
    text::Line,
    layout::{Constraint, Layout, Direction, Rect,},
    widgets::{Widget, Gauge, Block,},
    DefaultTerminal, Frame,
    prelude::{Color, Style, Span,},
};
...
impl Widget for &App {
    ...
    where
        Self: Sized,
        {
            let vertical_layout = Layout::default().direction(Direction::Vertical).constraints([Constraint::Percentage(20), Constraint::Percentage(80)]);
